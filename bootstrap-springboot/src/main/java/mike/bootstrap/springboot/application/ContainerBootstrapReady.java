...
/**
 * Interface to implement when the application is ready to ensure that the application resources are
 * configured before starting your business services.<br>
 * Overrides the method {@link ContainerBootstrapReady#onContainerReady()} to perform your
 * operations
 * 
 * @author Mike (2021-02)
 *

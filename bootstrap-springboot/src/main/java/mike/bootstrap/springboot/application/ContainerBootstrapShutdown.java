...
/**
 * Interface to implement on your shutdown component to ensure that all resources are safely closed
 * before stopping the services and the application.<br>
 * Overrides method {@link ContainerBootstrapShutdown#onContainerShutdown()} to perform operations
 * on shutdown
 * 
 * @author Mike (2021-02)
 *

...
class DatesTest {
    ...
    private static ZonedDateTime zonedDateTime = ZonedDateTime.of(2019, 3, 15, 15, 9, 34, 345000000,
            ZoneId.systemDefault());
    private static DateTimeFormatter defaultDateTimeFormatter = DateTimeFormatter
            .ofPattern("dd-MM-yyyy HH:mm");
    private static DateTimeFormatter defaultDateFormatter = DateTimeFormatter
    ...
    void toXxxDateEpoch_should_return_epoch_date_object() {
        ...
        assertThat(Dates.toZonedDateTimeEpoch())
                .isEqualTo(ZonedDateTime.of(localDateTimeEpoch, ZoneId.systemDefault()));
    ...
    void format_LocalDate_should_return_formatted_date() {
        ...
        assertThat(Dates.format(localDate, defaultDateFormatter)).isNotEmpty()
    ...
    void format_ZonedDateTime_should_return_formatted_date() {
        ...
        assertThat(zonedDateTimeFormatted).isNotEmpty().isEqualTo("2019-03-15T15:09:34.345+01:00");

        assertThat(Dates.format(zonedDateTime, defaultDateTimeFormatter)).isNotEmpty();

        var summerZonedDateTime = ZonedDateTime.of(2020, 10, 04, 15, 9, 34, 345000000,
                ZoneId.systemDefault());
    ...
    @ParameterizedTest
    @CsvSource({ "15-03-2019 03:56, true", "15-03-2019 03:56:06, false" })
    void isValid_should_return_expected_boolean_when_date_value(String dateValue,
            boolean expected) {

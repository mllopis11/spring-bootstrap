...
class PasswordTest {
    ...
    @ParameterizedTest
    @NullAndEmptySource
    @ValueSource(strings = { "             ", "6Char!", "Contains-More-Than-20-Characters",
            " C0ntains Sp@ces ", " St@rtW1thSpace", "3nd-With-space ", "OnlyCharacters",
            "No-Numbers!", "0123457689", "$0123457689", "GraterThan->Operat0r!" })

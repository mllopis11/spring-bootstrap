 ...
 * <p>
 * Remove with all leading and trailing white space then replace remaining white space(s) with the specified character 
 * and finally apply the function on the value.
 * 
 * @author Mike (2021-02)
 *
 */

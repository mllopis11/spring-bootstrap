...
public class Utils {
    ...
    public static String getArgv(String arg, String... defValue) {
        ...
        return items.length == 2 
                && ! items[0].isBlank() 
                && ! items[1].isBlank() ? items[1].trim() : Utils.defautValue(defValue);
    }
     ...
     * @return value with any leading and trailing whitespace or empty string if null
     */
     ...
     * @return the converted value or in case of any error occurs during conversion, the default value 
     *         otherwise a NumberFormatException is thrown
